...
//     <nav class="bg-white border-gray-300 dark:bg-gray-900 dark:border-gray-700">
//     <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
//         <Router>
//     <button class="flex items-center space-x-3 rtl:space-x-reverse" onClick={() => navigate("/")}>Home</button>
//           </Router>
//           <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Recipe Lookup</span>
